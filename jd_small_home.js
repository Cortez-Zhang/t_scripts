...
async function helpFriends() {
  ...
  if (!$.inviteCodes) await updateInviteCodeCDN('https://baidu.com/read/jd_updateSmallHomeInviteCode11.json');
...
function updateInviteCode(url = 'https://baidu.com/master/jd_updateSmallHomeInviteCode22.json') {
  return new Promise(resolve => {
...
function updateInviteCodeCDN(url = 'https://baidu.com/master/jd_updateSmallHomeInviteCode33.json') {
  return new Promise(async resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
